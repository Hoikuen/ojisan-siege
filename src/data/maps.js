...
export const MAPS = [
  ...
  },
  {
    ...
    startMoney: 150,
    startLives: 20,
    // ルート分岐 — 上ルートと下ルートの2本（敵がランダムに選択）
    // 上ルート: y=85→250（2レーン）  下ルート: y=415→580（2レーン）
    paths: [
      [[-60, 85],  [1150, 85],  [1150, 250], [-60, 250]],
      [[-60, 415], [1150, 415], [1150, 580], [-60, 580]],
    ],
    spots: [
      { x: 300, y: 167 }, { x: 560, y: 167 }, { x: 820, y: 167 }, { x: 1080, y: 167 },
      { x: 300, y: 497 }, { x: 560, y: 497 }, { x: 820, y: 497 }, { x: 1080, y: 497 },
    ],
    waves: generateWaves(4, 50),
  },
  {
    name: '地下街',
    bgKey: 'stage5',
    ...
    startMoney: 170,
    startLives: 20,
    // ルート分岐 — 3本ルート（上・中・下、敵がランダムに選択）
    // 上: y=72→207  中: y=277→412  下: y=482→612
    paths: [
      [[-60, 72],  [1100, 72],  [1100, 207], [-60, 207]],
      [[-60, 277], [1100, 277], [1100, 412], [-60, 412]],
      [[-60, 482], [1100, 482], [1100, 612], [-60, 612]],
    ],
    spots: [
      { x: 280, y: 139 }, { x: 560, y: 139 }, { x: 840, y: 139 }, { x: 1060, y: 139 },
      { x: 280, y: 344 }, { x: 560, y: 344 }, { x: 840, y: 344 }, { x: 1060, y: 344 },
      { x: 280, y: 547 }, { x: 560, y: 547 }, { x: 840, y: 547 }, { x: 1060, y: 547 },
    ],
    waves: generateWaves(5, 100),
  },
];
