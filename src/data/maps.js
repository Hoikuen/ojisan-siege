...
export const MAPS = [
  ...
  },
  {
    ...
    startMoney: 150,
    startLives: 20,
    // 4レーン蛇行 — レーン中心 y=85/250/415/580
    path: [
      [-60, 85], [1150, 85], [1150, 250], [130, 250],
      [130, 415], [1150, 415], [1150, 580], [-60, 580],
    ],
    spots: [
      { x: 320, y: 167 }, { x: 560, y: 167 }, { x: 800, y: 167 }, { x: 1040, y: 167 },
      { x: 320, y: 332 }, { x: 560, y: 332 }, { x: 800, y: 332 }, { x: 1040, y: 332 },
      { x: 320, y: 497 }, { x: 560, y: 497 }, { x: 800, y: 497 }, { x: 1040, y: 497 },
    ],
    waves: generateWaves(4),
  },
  {
    name: '地下街',
    bgKey: 'stage5',
    ...
    startMoney: 170,
    startLives: 20,
    // 5レーン蛇行 — レーン中心 y=72/207/342/477/612
    path: [
      [-60, 72], [1100, 72], [1100, 207], [180, 207],
      [180, 342], [1100, 342], [1100, 477], [180, 477],
      [180, 612], [1340, 612],
    ],
    spots: [
      { x: 340, y: 139 }, { x: 580, y: 139 }, { x: 820, y: 139 }, { x: 1060, y: 139 },
      { x: 340, y: 274 }, { x: 580, y: 274 }, { x: 820, y: 274 },
      { x: 340, y: 409 }, { x: 580, y: 409 }, { x: 820, y: 409 }, { x: 1060, y: 409 },
      { x: 340, y: 544 }, { x: 580, y: 544 }, { x: 820, y: 544 },
    ],
